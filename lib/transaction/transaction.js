...
Transaction.prototype.toBufferWriter = function(writer) {
  ...
  if (this.clam_speech && this.clam_speech.length > 0 && this.version == 2) {
    writer.writeVarintNum(this.clam_speech.length);
  }
  return writer;
};
...
Transaction.prototype.fromBufferReader = function(reader) {
  ...
  if (this.version == 2) { // clam speech transaction
      this.clam_speech = reader.readVarintNum();
  }
  return this;
};
...
Transaction.prototype.toObject = Transaction.prototype.toJSON = function toObject() {
  ...
  if(this.version === 2) {
    ...
    obj.clam_speech: this.clam_speech
  } else {
    obj.hash: this.hash,
    obj.version: this.version,
    obj.inputs: inputs,
...
Transaction.prototype.fromObject = function fromObject(arg) {
  ...
  if(this.version === 2) {
    ...
    this.clam_speech = transaction.clam_speech
  }
...
Transaction.prototype.isStake = function() {
